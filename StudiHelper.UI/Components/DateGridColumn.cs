namespace StudiHelper.UI.Components
{
  ...
  /// <summary>
  /// Data grid view cell to show date values
  /// </summary>
  public class DateGridCell : DataGridViewTextBoxCell
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="DateGridCell"/> class.
    /// </summary>
    public DateGridCell()
      : base()
    {
  ...
  /// <summary>
  /// Data grid view column to show date values
  /// </summary>
  public class DateGridColumn : DataGridViewTextBoxColumn
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="DateGridColumn"/> class.
    /// </summary>
    public DateGridColumn()
      : base()
    {
      CellTemplate = new DateGridCell();
    }
  }
}