namespace StudiHelper.UI
{
  ...
  public partial class MainForm : Form
  {
    public MainForm()
    {
      ...
      ModuleCombobox.DataSource = Core.BusinessLogic.BusinessLogicFactory.GetInstance().GetModules();
    }

    private void loadLessonsOfDay_Click(object sender, EventArgs e)
    {
      this.LessonsOfDay.DataSource = Core.BusinessLogic.BusinessLogicFactory.GetInstance().GetMergedLessonsOfDay(DayPickerDay.Value);
    }
    ...
    private void loadLessonsOfWeek_Click(object sender, EventArgs e)
    {
      ...
      List<MergedLesson> mergedLessons = Core.BusinessLogic.BusinessLogicFactory.GetInstance().GetMergedLessonsOfWeek(dayPickerWeek.Value, out legendLabels, out lessonLabels);
    ...
    private void ModuleCombobox_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      CursCombobox.DataSource = Core.BusinessLogic.BusinessLogicFactory.GetInstance().GetCursesByModul(((Module)ModuleCombobox.SelectedItem).ModuleID);
    }
    ...
    private void loadOfCurs_Click(object sender, EventArgs e)
    {
      ...
      lessonOfCurs.DataSource = Core.BusinessLogic.BusinessLogicFactory.GetInstance().GetMergedLessonsOfCurs(((Curs)CursCombobox.SelectedItem).CursID);
    }
