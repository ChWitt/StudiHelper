namespace StudiHelper
{
    partial class Main
    {
      ...
      this.startDataGridViewTextBoxColumn = new StudiHelper.DataGridViewTimeTextBoxColumn();
      this.endDataGridViewTextBoxColumn = new StudiHelper.DataGridViewTimeTextBoxColumn();
      ...
      this.startDate = new StudiHelper.DataGridViewDateTextBoxColumn();
      this.dataGridViewTimeTextBoxColumn1 = new StudiHelper.DataGridViewTimeTextBoxColumn();
      this.dataGridViewTimeTextBoxColumn2 = new StudiHelper.DataGridViewTimeTextBoxColumn();
      ...
      this.mergedLessonBindingSource.DataSource = typeof(StudiHelper.Objects.MergedLesson);
